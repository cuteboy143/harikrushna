    ...
    <div class="section">
        <div class="page-header">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Katha Sub Category</li>
            </ol>
             <div class="mt-3 mt-lg-0">
                <div class="d-flex align-items-center flex-wrap text-nowrap">
                    <a href="<?=base_url('admin/katha_subcategory/add')?>" class="btn btn-success btn-icon-text mr-2 d-none d-md-block"> <i class="fe fe-plus"></i> Add Sub Category</a>
                </div>
            </div>
        </div>
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">katha Sub Categories</h4>
                    </div>
                    <div class="card-body">
                                ...
                                <table id="tables" class="table table-striped table-bordered text-nowrap dataTable no-footer dtr-inline">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="border-bottom-0">Category Sub Name</th>
                                            <th class="border-bottom-0">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php $no = 0; if($katha_subcategory){ foreach($katha_subcategory as $key => $sta){ $no = $no + 1;?>
                                        <tr>
                                            <td><?=$no?></td>
                                            <td><?=$sta->name?></td>
                                            <td>
