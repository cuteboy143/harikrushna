                                ...
                                <?php echo form_open(current_url(), $attr); ?>
                                    ...
                                    <div class="form-group">
                                        <label class="custom-control custom-checkbox">
                                            <a href="<?= base_url('auth/forgot_password'); ?>" class="float-right small text-info">Forgot password?</a>
                                        </label>
                                    </div>
                                    <div class="form-footer mt-1">
                                        <button class="btn btn-success btn-block" type="submit">SignIn</button>
                                    </div>
                                <?php echo form_close(); ?>
                            </div>
                        </div>
